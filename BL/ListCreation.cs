...
namespace BL
{
    public class ListCreation
    {
        ...
        public async void CreateFaceListAsync(TextBox faceListTxtBox, Label result, Button createFaceListBtn)
        {
            createFaceListBtn.Enabled = false;
            ...
            createFaceListBtn.Enabled = true;
        }
        ...
        //
        public void WriteCompanyNameToFile()
        {
            Directory.CreateDirectory(@"C:\Generating Attendance Reports - Files");
